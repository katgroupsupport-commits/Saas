-- If any approver rejects or returns a request, close the whole approval batch.
-- Remaining approvers should no longer see the request as pending after refresh.
